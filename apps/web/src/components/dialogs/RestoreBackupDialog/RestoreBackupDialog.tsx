...
interface RestoreBackupDialogProps {
  onClose: () => void;
  /** Optional seeds for Storybook / visual regression. */
  initialImportMode?: ImportMode;
  initialImportResult?: ImportZipResult | null;
}

export function RestoreBackupDialog({
  onClose,
  initialImportMode = "merge",
  ...
  const [importResult, setImportResult] = useState<ImportZipResult | null>(initialImportResult);
