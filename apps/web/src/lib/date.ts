 ...
 * (UTC) — that silently points at the wrong day for any timezone ahead of UTC
 * (e.g. Turkey, UTC+3) during the hours after local midnight but before UTC
 * has rolled over.
 */
